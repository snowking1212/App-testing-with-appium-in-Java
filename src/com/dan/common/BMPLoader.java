...
//private static final Logger LOG =  LogManager.getLogger(BMPLoader.class);
private static Logger LOG =  Logger.getLogger(BMPLoader.class);	
	public static double compareImage(BufferedImage myImage, BufferedImage otherImage) {
		...
		LOG.error("相似像素数量：" + samePixels + " 不相似像素数量：" + numDiffPixels + " 相似率：" + String.format("%.1f", samePercent) + "%");
		return samePercent;
	}
